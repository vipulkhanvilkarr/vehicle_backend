...
from .views import DeleteUserView, UpdateUserView, UserCreateView, VehicleCreateView , CurrentUserView, VehicleDeleteView, VehicleListView, VehicleUpdateView, VehicleTypeListView, LoginView, LogoutView
